...
const IconCampaign = () => (
  <svg viewBox='0 0 24 24' fill='currentColor' width='20' height='20'>
    <path d='M18 11v2h2v-2h-2zm-2 6.61c.96.71 2.21 1.65 3.2 2.39.4-.53.8-1.07 1.2-1.6-.99-.74-2.24-1.68-3.2-2.4-.4.54-.8 1.08-1.2 1.61zM20.4 5.6c-.4-.53-.8-1.07-1.2-1.6-.99.74-2.24 1.68-3.2 2.39.4.53.8 1.07 1.2 1.6.96-.71 2.21-1.65 3.2-2.39zM4 9c-1.1 0-2 .9-2 2v2c0 1.1.9 2 2 2h1v4h2v-4h1l5 3V6L8 9H4zm11.5 3c0-1.33-.58-2.53-1.5-3.35v6.69c.92-.81 1.5-2.01 1.5-3.34z' />
  </svg>
);
const IconCalendar = () => (
...
export default function AdminDash () {
  ...
  const { datasummary, totalsummary } = useAuths();
const [activities, setActivities] = useState([])
  ...
  useEffect(() => {
    const fetchSummary = async () => {
      try {
        const res = await axios.get(`${BASE_URL}/adminsummary`);
  ...
  return (
    <>
     ...
     {  <div className='admin-dashboard-container'>
        {/* If you need AdminSide visible, render it here */}
        {/* <AdminSide /> */}
        <main className='admin-dashboard-main'>
          ...
          <div className='admin-dashboard-stats'>
            <div className='admin-dashboard-card card-users'>
              ...
              <h2>Total Users</h2>
              <div className='card-value'>{totalsummary.totalUsers}</div>
            ...
            <div className='admin-dashboard-card card-donations'>
              ...
              <div className='card-value'>
                ₹{totalsummary.totalDonationAmount}
              </div>
              <span className='card-trend up'>
                <IconUp />
                +8.4% this month
            ...
            <div className='admin-dashboard-card card-campaigns'>
              ...
              <div className='card-value'>{totalsummary.totalCampaigns}</div>
              <span className='card-trend up'>
                <IconUp />2 new this week
              </span>
            </div>
          </div>
